...
Explore
 @i386koba Sign out
1
0 0 i386koba/CelluCon.web
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights  Settings
CelluCon.web/docs/cellular-rc.js
852f74a  on 16 Nov 2017
@i386koba i386koba gapi.auth.authorize　immediate: false 削除
     
1360 lines (1327 sloc)  58.2 KB
...
function handleAuth() {
    ...
    gapi.auth.authorize({client_id: CLIENT_ID, scope: SCOPES.join(" "), prompt: 'select_account'}, handleAuthResult);
    return false;
}
